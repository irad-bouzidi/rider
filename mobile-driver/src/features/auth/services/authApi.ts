...
interface LoginResponse { userId: string; fullName: string; email: string; role: 'passenger' | 'driver'; accessToken: string; refreshToken: string; expiresIn: number; tokenType: string; }
...
export const authApi = {
  ...
  register: async (req: { email: string; phone: string; password: string; fullName: string }) => {
